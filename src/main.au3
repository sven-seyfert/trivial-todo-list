#pragma compile(FileVersion, 0.5.1)
#pragma compile(LegalCopyright, © Sven Seyfert (SOLVE-SMART))
#pragma compile(ProductVersion, 0.5.1 - 2025-01-17)
...
Func _Main()
    If @Compiled Then
        Local $mDownloadUrl[]
              $mDownloadUrl.VersionsIni   = 'https://raw.githubusercontent.com/sven-seyfert/app-versions/refs/heads/main'
              $mDownloadUrl.AppExecutable = 'https://github.com/sven-seyfert/trivial-todo-list/raw/refs/heads/main/build'
